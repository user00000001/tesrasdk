 ...
 */
//Provide some utils for tesrasdk
package utils
...
import (
	...
	nvutils "github.com/TesraSupernet/Tesra/smartcontract/service/native/utils"
	"os"
	"sort"
	"strings"
)
...
func GetAssetAddress(asset string) (common.Address, error) {
	...
	case "TSR":
		contractAddress = nvutils.TesraContractAddress
	case "TSG":
		contractAddress = nvutils.TsgContractAddress
	default:
		return common.ADDRESS_EMPTY, fmt.Errorf("asset:%s not equal tsr or tsg", asset)
	}
